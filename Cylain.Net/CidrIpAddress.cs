...
namespace Cylain.Net
{
    public class CidrIpAddress
    {
        ...
        #region [ constructors ]
        /// <summary>
        /// Initializes a new instance by Ip and subnet mask
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance by CidrIpAddress and subnet mask.
        ...
        /// <summary>
        /// Parses a cidr ip string and returns an instance of the CidrIpAddress
        /// </summary>
        ...
        /// <summary>
        /// Checks if the cidrIp belongs to the subnet of this instance
        /// </summary>
        ...
        /// <summary>
        /// Returns a string formatted in CIDR notation
        /// </summary>
        ...
        /// <summary>
        /// Returns a 3 line string containing the IP in bits, the mask in bits, and the subnet IP in bits.
        ...
        public string ToBinaryString()
        {
            ...
            {
                binaryIp += Convert.ToString(binaryIpBytes[i], 2) + (((i + 1) == binaryIpBytes.Length) ? "" : ".");
            }

            string binaryMask = "";
            for (var i = 0; i < SubnetIpMask.Length; i += 1)
            {
                binaryMask += Convert.ToString(SubnetIpMask[i], 2) + (((i + 1) == SubnetIpMask.Length) ? "" : ".");
            }
            ...
            for (var i = 0; i < SubnetIpMask.Length; i += 1)
            {
                binarySubnetIp += Convert.ToString(subnetIpBytes[i], 2) + (((i + 1) == subnetIpBytes.Length) ? "" : ".");
            }
